...
namespace SImpleBookManagement.Controllers
{
    ...
    public class BorrowedBooksController : Controller
    {
        ...
        {
            var applicationDbContext = _context.BorrowedBook.Include(b => b.Book).Include(b => b.Patron);
        ...
        public async Task<IActionResult> Create([Bind("Id,PatronId,BookId,BorrowDate,DueDate")] BorrowedBook borrowedBook)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Book, "Id", "Id", borrowedBook.BookId);
            ViewData["PatronId"] = new SelectList(_context.Patron, "Id", "Id", borrowedBook.PatronId);
            return View(borrowedBook);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PatronId,BookId,BorrowDate,DueDate")] BorrowedBook borrowedBook)
        {
